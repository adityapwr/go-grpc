...
func (x *BiDiGreetRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BiDiGreetRequest) ProtoMessage() {}

func (x *BiDiGreetRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BiDiGreetRequest.ProtoReflect.Descriptor instead.
func (*BiDiGreetRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{7}
}

func (x *BiDiGreetRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
func (x *BiDiGreetResponse) Reset() {
	*x = BiDiGreetResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *BiDiGreetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BiDiGreetResponse) ProtoMessage() {}

func (x *BiDiGreetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BiDiGreetResponse.ProtoReflect.Descriptor instead.
func (*BiDiGreetResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{8}
}

func (x *BiDiGreetResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x3f, 0x0a, 0x10, 0x42, 0x69, 0x44, 0x69, 0x47, 0x72,
	0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2b, 0x0a, 0x08, 0x67, 0x72,
	0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x08, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x2b, 0x0a, 0x11, 0x42, 0x69, 0x44, 0x69, 0x47,
	...
	0x73, 0x75, 0x6c, 0x74, 0x32, 0xa0, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65,
	...
	0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1c, 0x2e, 0x67,
	...
	0x01, 0x12, 0x44, 0x0a, 0x09, 0x42, 0x69, 0x44, 0x49, 0x47, 0x72, 0x65, 0x65, 0x74, 0x12, 0x17,
	0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x42, 0x69, 0x44, 0x69, 0x47, 0x72, 0x65, 0x65, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e,
	0x42, 0x69, 0x44, 0x69, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*BiDiGreetRequest)(nil),       // 7: greet.BiDiGreetRequest
	(*BiDiGreetResponse)(nil),      // 8: greet.BiDiGreetResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0, // 3: greet.BiDiGreetRequest.greeting:type_name -> greet.Greeting
	...
	7, // 7: greet.GreetService.BiDIGreet:input_type -> greet.BiDiGreetRequest
	...
	8, // 11: greet.GreetService.BiDIGreet:output_type -> greet.BiDiGreetResponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BiDiGreetResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GreetService_BiDIGreetClient interface {
	Send(*BiDiGreetRequest) error
	Recv() (*BiDiGreetResponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceBiDIGreetClient) Send(m *BiDiGreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceBiDIGreetClient) Recv() (*BiDiGreetResponse, error) {
	m := new(BiDiGreetResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetService_BiDIGreetServer interface {
	Send(*BiDiGreetResponse) error
	Recv() (*BiDiGreetRequest, error)
	grpc.ServerStream
}
...
func (x *greetServiceBiDIGreetServer) Send(m *BiDiGreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceBiDIGreetServer) Recv() (*BiDiGreetRequest, error) {
	m := new(BiDiGreetRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
